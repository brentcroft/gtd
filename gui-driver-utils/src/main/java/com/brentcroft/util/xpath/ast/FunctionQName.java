/* Generated By:JJTree: Do not edit this line. FunctionQName.java Version 6.0 */
...
public class FunctionQName extends SimpleNode
{
    public FunctionQName( int id )
    {
        super( id );
    }

    public FunctionQName( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=8205645c85ac7260c543a827d54ceb53 (do not edit this line) */
