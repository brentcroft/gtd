/* Generated By:JJTree: Do not edit this line. AbbrevReverseStep.java Version 6.0 */
...
public class AbbrevReverseStep extends SimpleNode
{
    public AbbrevReverseStep( int id )
    {
        super( id );
    }

    public AbbrevReverseStep( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=d77ac660797c39a52f20532aa32a7ca4 (do not edit this line) */
