/* Generated By:JJTree: Do not edit this line. CommentTest.java Version 6.0 */
...
public class CommentTest extends SimpleNode
{
    public CommentTest( int id )
    {
        super( id );
    }

    public CommentTest( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=87c5407542d3b7b7595a45b00ac87e23 (do not edit this line) */
