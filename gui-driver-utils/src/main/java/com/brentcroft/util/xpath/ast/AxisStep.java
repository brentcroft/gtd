/* Generated By:JJTree: Do not edit this line. AxisStep.java Version 6.0 */
...
public class AxisStep extends SimpleNode
{
    public AxisStep( int id )
    {
        super( id );
    }

    public AxisStep( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=417381feeff0c846a5b5e0e83379205e (do not edit this line) */
