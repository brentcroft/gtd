/* Generated By:JJTree: Do not edit this line. MultiplicativeExpr.java Version 6.0 */
...
public class MultiplicativeExpr extends SimpleNode
{
    public MultiplicativeExpr( int id )
    {
        super( id );
    }

    public MultiplicativeExpr( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=ce03ff15fd311c0fd20c758d51ec4730 (do not edit this line) */
