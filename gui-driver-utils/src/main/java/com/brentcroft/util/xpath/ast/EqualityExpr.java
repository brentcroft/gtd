/* Generated By:JJTree: Do not edit this line. EqualityExpr.java Version 6.0 */
...
public class EqualityExpr extends SimpleNode
{
    public EqualityExpr( int id )
    {
        super( id );
    }

    public EqualityExpr( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=c0f497440d674a2fcbd61606c33fe397 (do not edit this line) */
