/* Generated By:JJTree: Do not edit this line. NCName.java Version 6.0 */
...
public class NCName extends SimpleNode
{
    public NCName( int id )
    {
        super( id );
    }

    public NCName( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=e3618070b7315120e0b112cf6fa6521a (do not edit this line) */
