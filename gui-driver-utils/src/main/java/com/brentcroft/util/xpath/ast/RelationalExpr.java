/* Generated By:JJTree: Do not edit this line. RelationalExpr.java Version 6.0 */
...
public class RelationalExpr extends SimpleNode
{
    public RelationalExpr( int id )
    {
        super( id );
    }

    public RelationalExpr( XParser p, int id )
    {
        super( p, id );
    }
...
/* JavaCC - OriginalChecksum=295f2871cfbf0424cab200a7ed32d978 (do not edit this line) */
