...
{
	public W3cHTMLLabelElementGuiObject( T go, Gob parent, GuiObjectConsultant< T > guiObjectConsultant,
	...
	{
		TEXT( "text",
				go -> ofNullable( DataLimit.MAX_TEXT_LENGTH.maybeTruncate( go.getTextContent() ) ).orElse( null ) );
