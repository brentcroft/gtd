...
//                    {
//                        logger.trace( format( "Rejected event: event-id=[%s]; seq=[%s], param=[%s].", eventId, seq, param ) );
//                    }
//
//                    return null;
//                }
     ...
     */
    {
        withConditionIn( notification -> ( notification != null && (
                "awt-event".equals( notification.getType() )
