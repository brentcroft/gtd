 ...
 * 
 */
public class TableItemGuiObject< T extends TableItem > extends ItemGuiObject< T > implements GuiObject.Click
{
	public TableItemGuiObject( T go, Gob parent, GuiObjectConsultant< T > guiObjectConsultant, CameraObjectManager objectManager )
	{
	...
	enum Attr implements AttrSpec< TableItem >
	{
		...
		final String n;
		final Function< TableItem, Object > f;

		Attr( String name, Function< TableItem, Object > f )
		{
			this.n = name;
			this.f = f;
		}
		...
		@Override
		public String getAttribute( TableItem go )
		{
