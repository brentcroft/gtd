 ...
 * 
 */
public class ToolItemGuiObject< T extends ToolItem > extends ItemGuiObject< T > implements GuiObject.Click
{
    public ToolItemGuiObject( T go, Gob parent, GuiObjectConsultant< T > guiObjectConsultant, CameraObjectManager objectManager )
    {
	...
	enum Attr implements AttrSpec< ToolItem >
	{
		...
		final String n;
		final Function< ToolItem, Object > f;

		Attr( String name, Function< ToolItem, Object > f )
		{
			this.n = name;
			this.f = f;
		}
		...
		@Override
		public String getAttribute( ToolItem go )
		{
